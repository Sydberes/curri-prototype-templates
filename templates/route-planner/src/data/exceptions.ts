...
export const EXCEPTION_ROWS: ExceptionRow[] = [
  ...
  },
  {
    ...
    route: '#1248',
    order: 'BNMVWS',
    pickup: '400 Howard St',
    dropoff: '1100 Folsom St',
    driver: 'Deshawn M.',
    detected: '8m ago',
  },
  {
    ...
    route: '#1251',
    order: 'LPQMXZ',
    pickup: '55 Fremont St',
    dropoff: '2200 Mission St',
    driver: 'Tomas E.',
    detected: '11m ago',
  },
  {
  ...
  },
  {
    ...
    route: '#1249',
    order: 'MSA-002',
    pickup: '900 Brannan St',
    dropoff: '1550 Mission St',
    driver: 'Carlos R.',
    detected: '14m ago',
  },
]
...
export function topSeverity(rows: ExceptionRow[]): Severity | null {
...
export function laneException(lane: PlannerLane): ExceptionRow | undefined {
  return EXCEPTION_ROWS.find((e) => e.route === lane.routeName.replace('Route ', ''))
}
